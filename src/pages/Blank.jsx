...
const Blank = () => {
    ...
    <div class="titre"><h1>Unlocks</h1></div>
    ...
    <div class="product">
    <div> <span class="nameprod">JOUEUR STAR </span></div>
    <div><button class="prix2"><h1>200000$</h1></button></div>
    <div class="description"> Joueur d'une classe et d'une renommée rarement atteinte, une légende à en devenir</div>
    </div>

    <div class="product">
    <div> <span class="nameprod">JOUEUR DE LEGENDE </span></div>
    <div><button class="prix2"><h1>500000$</h1></button></div>
    <div class="description"> Légende du football, joueur ayant marqué l'histoire du sport</div>
    </div>
